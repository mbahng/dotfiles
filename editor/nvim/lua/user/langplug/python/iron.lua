return { "Vigemus/iron.nvim",                              -- interactive REPL
  config = function() 
    ...
    -- Easy access to REPL for Python
    vim.api.nvim_set_keymap("n", ":repl<cr>", ":IronRepl<cr>", { noremap = true, silent = true })
    vim.api.nvim_set_keymap('n', '<space>rf', '<cmd>IronFocus<cr>', { noremap = true, silent = true })
    vim.api.nvim_set_keymap('n', '<space>rh', '<cmd>IronHide<cr>', { noremap = true, silent = true })
    vim.api.nvim_set_keymap("n", "<leader>rr", ":IronRestart<cr>", { noremap = true, silent = true })
    vim.api.nvim_set_keymap("t", "1jk", "<C-\\><C-n>", { noremap = true, silent = true })
  end
}
